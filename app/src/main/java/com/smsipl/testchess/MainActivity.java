...
import com.smsipl.testchess.Pieces.Bishop;
import com.smsipl.testchess.Pieces.King;
import com.smsipl.testchess.Pieces.Knight;
import com.smsipl.testchess.Pieces.Pawn;
import com.smsipl.testchess.Pieces.Piece;
import com.smsipl.testchess.Pieces.Queen;
import com.smsipl.testchess.Pieces.Rook;
...
//                                        game_over.setVisibility(View.VISIBLE);
    ...
    private void showAlertDialog() {
        ...
        builder.setMessage("For restart game press 'ok'.");
    ...
    private void showAlertDialogForInstuructions() {
        ...
        builder.setMessage("For step back use 'UNDO' button &"+"\n"+"It is two player game.");
